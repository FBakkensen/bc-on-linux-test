...
codeunit 50006 "Max Sellable Subscribers"
{
    ...
    local procedure ClearMaxSellableOnStockoutOff(var Rec: Record "Sales & Receivables Setup")
    begin
    ...
    local procedure OnAfterValidateShipmentDate(var Rec: Record "Sales Line")
    begin
        RunWithProdInterfaces(Rec);
    end;
    ...
    local procedure OnAfterValidateVariantCode(var Rec: Record "Sales Line")
    begin
        RunWithProdInterfaces(Rec);
    end;
